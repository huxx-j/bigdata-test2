...
ACCESS_TOKEN = "EAACEdEose0cBAMuENfZBCgth8PLvII29d9OinmCPqNNRzqxZAZAQAI6GCxL5PlcCZBLBEq4mT9dNkMwxduiaURZAcdotftQKxEshxiXMjzZCyOboU4lkwc7VPblcv9GialZCnPYSSMMfMNjYz8OeRDcFtJWNyL5dkvbpqgLwIe5mwgDXsjBr6kUKclggZAJ8dWvZCz7SG7NtWZAwZDZD"
LIMIT_REQUEST = 10
pagename = "jtbcnews"
...
def fb_get_post_list(pagename, from_date, to_date):
    ...
    with open("D:/Bigdata/facebook/" + pagename + ".json", 'w', encoding='utf-8') as outfile:
