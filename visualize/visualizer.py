...
def show_gragh_bar(dict_word, pagename):
    # 한글처리
    font_filename = 'C:/Windows/Fonts/HMFMPYUN.TTF'
    ...
    save_filename = "D:/Bigdata/facebook/%s_bar_gragh.png" % pagename
...
def word_cloud(dict_word, pagename):
    ...
    save_filename = "D:/Bigdata/facebook/%s_word_cloud.jpg" % pagename
